...
//Console.WriteLine("EEEa "+Name );
     ...
     else if (o is ifcListInterface)  {((ifcListInterface)o).ToIfcXml(xml);} // noch anders l�sen 
     else                    {}// error
...
/*
if(1==2)
foreach (FieldInfo f in InverseList) {// �ber Listenelemnete iterieren
                                      // Pr�fung ob Listenelemente bereits verwendet 
